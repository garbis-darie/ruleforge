...
import { createRng, intBetween, pickWeighted } from "./rng.js";
...
export function generateAlerts({ seed = 42, count = 1200, startedAt = "2026-01-01T00:00:00.000Z" } = {}) {
...
export function buildPayload(alerts, { seed, count, startedAt }) {
  return {
    metadata: {
